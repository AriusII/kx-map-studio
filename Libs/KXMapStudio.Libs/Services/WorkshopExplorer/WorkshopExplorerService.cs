...
/// <summary>
///     UI-facing explorer service (WPF). Handles filesystem scanning, tree construction, and path validation.
/// </summary>
public sealed class WorkshopExplorerService : IWorkshopExplorerService
{
	...
	{
		// Scan the filesystem synchronously (no cancellation on this legacy path).
		var scan = ScanAsync(DataFolder, WorkshopExplorerConstants.AllowedFileExtensions, CancellationToken.None)
	...
	/// </summary>
	private Task<WorkshopExplorerScanNode> ScanAsync(
		string rootPath,
